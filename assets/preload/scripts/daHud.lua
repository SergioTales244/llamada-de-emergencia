...
function onCreatePost()
    ...
    setObjectCamera("songName", "other") -- set text camera
    ...
    if (settings.hideTimeBar) == false then
        ...
        makeLuaText("totalTime", "2:30", 1, screenWidth - 60, 20)
